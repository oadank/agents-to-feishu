...
const name = 'cti-builtin-tools'
const inject = ['tools'] // agents-to-feishu 收编版：acp-demo 无 webServer，HTTP 路由由守卫跳过
...
async function apply(ctx) {
  ...
  ctx.effect(() => {
    // agents-to-feishu 收编版：acp-demo 无 webServer 服务，cordis 禁止未 inject 的属性访问 ⇒ try/catch 安全取值
    let webServer;
